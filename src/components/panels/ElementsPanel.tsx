...
export const ElementsPanel = observer(({elementtype}:ElementsPanelProps) => {
  ...
  return (
  <div className="w-[19.7%] hidden min-[922px]:flex h-[510px] max-h-[510px]  min-[977px]:flex-col border border-red-500 m-[1px] p-[1px]  min-[977px]:items-center min-[977px]:justify-start">
