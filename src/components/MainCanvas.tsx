...
export const MainCanvas = observer(() => {
  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center border border-green-500  grow shrink basis-0 m-[1px] p-[1px] h-[510px] min-w-[33%] max-w-[74%]'>
    <div className='flex flex-col border  border-yellow-400 w-full m-[1px] p-[1px] justify-center items-center '>
        <div className='inline-flex m-[1px] flex-row items-center justify-center border border-green-500 p-1 w-[210px] h-[40px] max-w-[210px] max-h-[40px] gap-3'>
